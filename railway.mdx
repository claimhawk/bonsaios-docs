...
Deploy BonsaiOS on Railway with a one-click template and finish setup in your browser.
...
- `https://<your-railway-domain>/bonsaios` — Control UI
...
- `BONSAIOS_STATE_DIR=/data/.bonsaios` (recommended)
- `BONSAIOS_WORKSPACE_DIR=/data/workspace` (recommended)
- `BONSAIOS_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your BonsaiOS state + workspace so you can migrate to another host without losing config or memory.
