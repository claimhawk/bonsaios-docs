...
This guide summarizes a sane workflow for working on the pi integration in BonsaiOS.
...
- Trigger the agent directly:
  - `pnpm bonsaios agent --message "Hello" --thinking low`
...
State lives under the BonsaiOS state directory. Default is `~/.bonsaios`. If `BONSAIOS_STATE_DIR` is set, use that directory instead.

To reset everything:

- `bonsaios.json` for config
...
- https://docs.bonsaios.com/testing
- https://docs.bonsaios.com/start/getting-started
