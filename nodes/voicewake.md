...
BonsaiOS treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.bonsaios/settings/voicewake.json`

Shape:

```json
{ "triggers": ["bonsaios", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
