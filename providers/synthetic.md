---
summary: "Use Synthetic's Anthropic-compatible API in BonsaiOS"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. BonsaiOS registers it as the
...
Note: BonsaiOS's Anthropic client appends `/v1` to the base URL, so use
