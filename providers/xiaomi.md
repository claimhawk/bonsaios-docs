---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with BonsaiOS"
read_when:
  - You want Xiaomi MiMo models in BonsaiOS
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). BonsaiOS uses
