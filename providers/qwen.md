---
summary: "Use Qwen OAuth (free tier) in BonsaiOS"
read_when:
  - You want to use Qwen with BonsaiOS
...
If you already logged in with the Qwen Code CLI, BonsaiOS will sync credentials
