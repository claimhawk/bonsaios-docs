...
You can point BonsaiOS at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or BonsaiOS
...
- [Anthropic provider](/providers/anthropic) - Native BonsaiOS integration with Claude setup-token or API keys
