...
BonsaiOS has two separate “streaming” layers:
...
When block streaming is enabled, BonsaiOS can **merge consecutive block chunks**
...
When draft streaming is active, BonsaiOS disables block streaming for that reply to avoid double-streaming.
