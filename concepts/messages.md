...
This page ties together how BonsaiOS handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. BonsaiOS keeps a
...
BonsaiOS separates the **prompt body** from the **command body**:
...
BonsaiOS can expose or hide model reasoning:
