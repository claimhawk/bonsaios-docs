...
read_when:
  - You are building a BonsaiOS plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (bonsaios.plugin.json)

Every plugin **must** ship a `bonsaios.plugin.json` file in the **plugin root**.
BonsaiOS uses this manifest to validate configuration **without executing plugin
