...
read_when:
  - Installing BonsaiOS on Windows
...
BonsaiOS on Windows is recommended **via WSL2** (Ubuntu recommended). The
...
- Remote nodes must point at a **reachable** Gateway URL (not `127.0.0.1`); use
  `bonsaios status --all` to confirm.
