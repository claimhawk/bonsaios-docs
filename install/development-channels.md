...
BonsaiOS ships three update channels:
...
When you **explicitly** switch channels with `--channel`, BonsaiOS also aligns
the install method:
...
When you switch channels with `bonsaios update`, BonsaiOS also syncs plugin sources:
