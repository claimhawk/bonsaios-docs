...
- Install via CLI: `bonsaios plugins install @bonsaios/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `bonsaios plugins install ./extensions/zalo`
   - From npm (if published): `bonsaios plugins install @bonsaios/zalo`
...
- Approve via:
  - `bonsaios pairing list zalo`
  - `bonsaios pairing approve zalo <CODE>`
...
- Example: `bonsaios message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `bonsaios channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `bonsaios logs --follow`
