...
read_when:
  - You want BonsaiOS to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables BonsaiOS to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`bonsaios onboard`) and `bonsaios channels add` list optional channel plugins.
...
```bash
bonsaios plugins install @bonsaios/nostr
```

Use a local checkout (dev workflows):

```bash
bonsaios plugins install --link <path-to-bonsaios>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "bonsaios",
        "displayName": "BonsaiOS",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "bonsaios@example.com",
        "lud16": "bonsaios@example.com"
      }
    }
  }
}
